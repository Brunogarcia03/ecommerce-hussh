  ...
  return (
    <>
      ...
      {open &&
        createPortal(
          <div
            className="fixed inset-0 z-999 flex items-end md:items-center justify-center bg-black/80 backdrop-blur-md p-0 md:p-6"
            onClick={(e) => {
              if (e.target === e.currentTarget) setOpen(false);
            }}
          >
            <div className="relative w-full md:max-w-2xl max-h-[90vh] overflow-y-auto bg-black border border-white/20 p-5 md:p-6 flex flex-col gap-6">
              {/* Modal header */}
